...
use rustls::client::{
    CertificateTransparencyPolicy, ClientSessionMemoryCache, ServerCertVerifier, WebPkiVerifier,
};

use crate::suites::SupportedCipherSuite;
use rustls::{Certificate, PrivateKey, RootCertStore, SupportedKxGroup};
// use rustls::verify::{self, CertificateTransparencyPolicy};
use crate::versions;
use rustls::NoKeyLog;
...
impl ConfigBuilder<ClientConfig, WantsTransparencyPolicyOrClientCert> {
    ...
    //     self.with_logs(None)
    //         .with_client_cert_resolver(Arc::new(FailResolveClientCert {}))
    // }
    ...
    fn with_logs(
        ...
        ConfigBuilder {
            state: WantsClientCert {
                ...
                kx_groups: self.state.kx_groups,
                versions: self.state.versions,
                verifier: Arc::new(WebPkiVerifier::new(self.state.root_store, ct_policy)),
            },
            side: PhantomData,
        }
    }
...
impl ConfigBuilder<ClientConfig, WantsClientCert> {
    ...
    pub fn with_client_cert_resolver(
        ...
        ClientConfig {
            ...
            session_storage: ClientSessionMemoryCache::new(256),
